...
document.addEventListener("DOMContentLoaded", function () {
    ...
    gsap.from(e, { textContent: 0, duration: 4, ease: Power1.easeIn, snap: { textContent: 1 }, stagger: 1 }),
        gsap.from(".extimation-line", { duration: 4, width: 0, stagger: 1, ease: Power4.easeIn }, 0.5),
